...
private:
    ...
    Solution generateChild(const Cala::Model *model, const std::vector<Solution> &population) const;
    std::vector<Solution> generateOffspring(const Cala::Model *model, const std::vector<Solution> &population) const;
